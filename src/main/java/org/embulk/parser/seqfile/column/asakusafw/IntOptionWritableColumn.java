...
public class IntOptionWritableColumn extends AbstractIntWritableColumn {

    private final IntOption writableValue = new IntOption();

    public IntOptionWritableColumn(PluginTask task, Column column, ColumnOptionTask option) {
